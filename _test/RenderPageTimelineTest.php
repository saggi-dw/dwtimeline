...
TXT;
    ...
    public function test_non_existing_page()
    {
        ...
        $this->assertStringContainsString('rp_not_found', strip_tags($html), 'Missing not-found message key');
    }
    ...
    public function test_self_include_guard()
    {
        ...
        $this->assertStringContainsString('rp_same', strip_tags($html), 'Missing same-page guard');
    }
}