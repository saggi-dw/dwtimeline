...
/**
 * General tests for the dwtimeline plugin
 *
...
class GeneralTest extends DokuWikiTest
{
    ...
    public function testPluginInfo(): void
    {
        ...
        $this->assertEquals('dwtimeline', $info['base']);
        ...
        if ($conf !== null && $meta !== null) {
            foreach ($conf as $key => $value) {
                $this->assertArrayHasKey(
                    $key,
                    $meta,
                    'Key $meta[\'' . $key . '\'] missing in ' . DOKU_PLUGIN . 'dwtimeline/conf/metadata.php'
                );
            }
            ...
            foreach ($meta as $key => $value) {
                $this->assertArrayHasKey(
                    $key,
                    $conf,
                    'Key $conf[\'' . $key . '\'] missing in ' . DOKU_PLUGIN . 'dwtimeline/conf/default.php'
                );
            }
        }
    }
